        		...
        		<div class="card-body">
	        		<form method="post"	id="change_password_form">
					    ...
					    <div class="form-group" align="center">
					    	...
					    	<input type="submit" name="user_password" id="user_password" class="btn btn-info" style="color:#ffffff;border: none;background-image: linear-gradient(90deg, #009ACD, #00BFFF);" value="Change" />
					    </div>
	        		</form>
        		</div>
      		</div>
