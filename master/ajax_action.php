...
if(isset($_POST['page']))
{
	...
	if($_POST['page'] == 'exam')
	{
		if($_POST['action'] == 'fetch')
		{
			...
			if(isset($_POST['search']['value']))
			{
				...
				$exam->query .= 'OR user_class LIKE "%'.$_POST["search"]["value"].'%" ';
		...
		if($_POST['action'] == 'Add')
		{
			...
			(admin_id, online_exam_title, online_exam_datetime, user_class, total_question, marks_per_right_answer, marks_per_wrong_answer, online_exam_created_on, online_exam_status, online_exam_code) 
			VALUES (:admin_id, :online_exam_title, :online_exam_datetime, :user_class, :total_question, :marks_per_right_answer, :marks_per_wrong_answer, :online_exam_created_on, :online_exam_status, :online_exam_code)
			";
		...
		if($_POST['action'] == 'edit_fetch')
		{
			...
			foreach($result as $row)
			{
				...
				$output['user_clasn'] = $row['user_class'];
		...
		if($_POST['action'] == 'Edit')
		{
			...
			SET online_exam_title = :online_exam_title, online_exam_datetime = :online_exam_datetime, user_class = :user_class, total_question = :total_question, marks_per_right_answer = :marks_per_right_answer, marks_per_wrong_answer = :marks_per_wrong_answer  
	...
	if($_POST['page'] == 'question')
	{
		...
		if($_POST['action'] == 'delete')
		{
			...
			$exam->query = "DELETE FROM question_table WHERE question_id = :question_id";

			$exam->execute_query();

			$exam->query = "DELETE FROM option_table WHERE question_id = :question_id";
	...
	if($_POST['page'] == 'exam_enroll')
	{
		if($_POST['action'] == 'fetch')
		{
			...
			if(isset($_POST['search']['value']))
			{
				...
				$exam->query .= 'OR user_table.user_class LIKE "%'.$_POST["search"]["value"].'%" ';
			}
			$exam->query .= ') ';
